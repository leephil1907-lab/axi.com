        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
          ...
          <div className="space-y-6 text-gray-700">
            <section>
              ...
              <p className="leading-relaxed">This GDPR Compliance governs your use of AXI Trading services. By accessing or using our platform, you agree to be bound by these terms.</p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">For questions regarding this GDPR Compliance, contact us at legal@axi-trading.com or call +1-800-888-8888.</p>
            </section>
          </div>
