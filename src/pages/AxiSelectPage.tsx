...
export default function AxiSelectPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1A1A1A] text-white">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-[#D51820] to-red-800 py-4">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold mb-4">axi<span className="text-[#D51820]">SELECT</span></h1>
          <h2 className="text-2xl font-semibold mb-4">Your first step to start your path to get <span className="text-[#D51820]">$1,000,000</span> funding</h2>
          ...
          <div className="flex gap-4">
            <button className="bg-[#D51820] text-white px-6 py-2 rounded-lg font-semibold hover:bg-red-700">ADD FUNDS</button>
        ...
        <div className="bg-gray-900 rounded-xl p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-sm text-[#D51820] flex items-center gap-1">Detail Pathway <ChevronRight className="w-4 h-4" /></button>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 bg-[#D51820] text-white px-3 py-2 rounded-lg text-sm font-semibold">
              Next: Seed
            </div>
            <ArrowRight className="w-4 h-4 text-gray-600" />
        ...
        <div className="bg-gray-900 rounded-xl p-6 mb-8">
          ...
          <p className="text-sm text-[#D51820] text-center mb-6">0 of 3 Complete</p>
