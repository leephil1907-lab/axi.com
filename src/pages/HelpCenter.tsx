        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="relative max-w-xl mx-auto">
            ...
            <input
              ...
              className="w-full bg-white/10 border border-white/20 rounded-xl pl-12 pr-4 py-4 text-white placeholder-gray-400 focus:outline-none focus:border-[#D51820]"
            />
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-12">
          {categories.map((cat) => (
            <button
              ...
              className={`bg-white rounded-xl border-2 p-6 text-left transition-all hover:shadow-md ${activeCategory === cat.title ? 'border-[#D51820]' : 'border-gray-200'}`}
            >
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-12">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
              <MessageCircle className="w-8 h-8 text-[#D51820]" />
              <div>
            ...
            <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
              <Mail className="w-8 h-8 text-[#D51820]" />
              <div>
            ...
            <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
              <Phone className="w-8 h-8 text-[#D51820]" />
              <div>
