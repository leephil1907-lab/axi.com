...
const comparisonData = [
  { feature: "Timeframes", demo: "21", real: "21" },
  { feature: "Indicators", demo: "38 built-in", real: "38 built-in" },
  { feature: "Economic Calendar", demo: "Built-in", real: "Built-in" },
  { feature: "Depth of Market", demo: "Available", real: "Available" },
  { feature: "Execution Speed", demo: "64-bit fast", real: "64-bit fast" },
  ...
  { feature: "EAs & Scripts", demo: "MQL5 full access", real: "MQL5 full access" },
];
          ...
          <div className="grid grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex gap-4">
                <Link 
                  to="/register?type=demo&platform=mt5" 
                ...
                <Link 
                  to="/register?type=real&platform=mt5" 
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-center py-3 text-[#D51820] font-semibold">MT5</th>
                  </tr>
                </thead>
                <tbody>
                  {[
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-white text-center">
            ...
            <div className="flex justify-center gap-4">
              <Link to="/register?type=demo&platform=mt5" className="bg-white text-blue-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                Open Demo Account
              </Link>
              <Link to="/register?type=real&platform=mt5" className="bg-white/20 border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white/30 transition-colors">
                Open Real Account
              </Link>
            </div>
          </div>
