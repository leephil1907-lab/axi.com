      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
          ...
          <div className="space-y-8">
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-2"><Shield className="w-5 h-5 text-[#D51820]" /> Introduction</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-2"><Database className="w-5 h-5 text-[#D51820]" /> Information We Collect</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-2"><Eye className="w-5 h-5 text-[#D51820]" /> How We Use Your Information</h2>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-2"><Share2 className="w-5 h-5 text-[#D51820]" /> Data Sharing</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-2"><Lock className="w-5 h-5 text-[#D51820]" /> Data Security</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-2"><Globe className="w-5 h-5 text-[#D51820]" /> International Transfers</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-2"><Mail className="w-5 h-5 text-[#D51820]" /> Contact Us</h2>
