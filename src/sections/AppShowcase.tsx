        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-[#E5B80C] hover:bg-[#d4a90b] text-gray-900 px-8 py-3 rounded text-sm font-bold transition-colors">Download now</button>
              ...
              <div className="bg-white rounded-[2rem] overflow-hidden h-[480px] relative">
                ...
                <div className="px-5 pt-2 pb-4">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div className="w-8 h-8 bg-[#E5B80C] rounded-full flex items-center justify-center text-sm font-bold">+</div>
                  </div>
                ...
                <div className="flex gap-2 px-5 mb-4">
                  <span className="bg-[#D51820] text-white text-xs px-4 py-1.5 rounded-full">All</span>
                ...
                <div className="absolute bottom-3 left-0 right-0 flex justify-center gap-1.5">
                  {slides.map((_, i) => <span key={i} className={`w-2 h-2 rounded-full ${i === slide ? 'bg-[#D51820]' : 'bg-gray-300'}`} />)}
                </div>
              </div>
            </div>
          </div>
