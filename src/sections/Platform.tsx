...
export default function Platform() {
  ...
  return (
    <section id="platform" ref={ref} className="py-20" style={{ backgroundColor: "#D31C2B" }}>
      <div className="container-axi flex flex-col md:flex-row items-center gap-10">
        ...
        >
          <img src="/platform-illustration.png" alt="Trading Platform" className="max-w-full md:max-w-[500px] h-auto" />
        </motion.div>
      </div>
    </section>
  );
