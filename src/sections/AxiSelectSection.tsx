    ...
    <section className="py-16 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl font-bold mb-2"><span className="text-[#D51820]">axi</span>SELECT</h2>
          ...
          <div className="flex justify-center gap-3">
            <Link to="/funds" className="bg-[#D51820] hover:bg-[#b8141b] text-white px-6 py-2.5 rounded text-sm font-bold transition-colors">ADD FUNDS</Link>
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center gap-2">
            {['Joined Axi Select', 'Next: Seed', 'Incubation', 'Acceleration'].map((step, i) => (
              <div key={i} className={`flex-1 py-2 px-3 rounded text-xs font-medium text-center ${i===0?'bg-green-600 text-white':i===1?'bg-[#D51820] text-white':'bg-gray-800 text-gray-500'}`}>{i===0&&'\u2713 '}{step}</div>
            ))}
          </div>
        </div>
        <div className="mb-12">
        ...
        <div className="overflow-x-auto">
          <h4 className="text-center text-lg font-bold mb-4"><span className="text-[#D51820]">axi</span> SELECT Pathway</h4>
