export default function PlatformsSection() {
  return (
    <section id="platforms" className="bg-[#D51820] py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <button className="bg-[#E5B80C] hover:bg-[#d4a90b] text-gray-900 px-8 py-3 rounded text-sm font-bold transition-colors">Get the technology edge</button>
          </div>
