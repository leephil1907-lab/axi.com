...
const categories = [
  { icon: "/icon-forex.png", label: "Forex" },
  { icon: "/icon-indices.png", label: "Shares" },
  { icon: "/icon-commodities.png", label: "Indices" },
  { icon: "/icon-metals.png", label: "Commodities" },
  { icon: "/icon-crypto.png", label: "Cryptocurrencies" },
];
