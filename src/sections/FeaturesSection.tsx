    ...
    <section id="features" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <div key={i} className="group p-6 rounded-2xl border border-gray-100 bg-white hover:shadow-xl hover:border-[#D51820]/20 transition-all duration-300">
              <div className="w-12 h-12 bg-[#D51820]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#D51820] transition-colors">
                <f.icon className="w-6 h-6 text-[#D51820] group-hover:text-white transition-colors" />
              </div>
